...
echo -e " Auther : ${green}St Pusat A1 ${NC}"
echo -e " © Blitar Udanawu Jatim ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
"'&reply_markup={"inline_keyboard":[[{"text":"","url":"https://wa.me/+6281931615811"}]]}' 
